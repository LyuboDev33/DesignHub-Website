...
class ProductController extends Controller
{
    ...
    public function get_discounts () { 
       ...
       $discountedProducts =  DB::table('products')
        ...
        return view("layouts.main-website.discounts", ["discounted_products" => $discountedProducts]);

    }

    public function get_all_products () { 
        
       $theprocuts = DB::table('products')
        ->orderBy('id', 'desc')
        ->get();

        return view('layouts.main-website.shop', ['products' =>$theprocuts]);
    ...
    public function get_Category ($data) { 
        ...
        return view('layouts.main-website.category', ['products_category' => $pass_products]);
