$.ajax({
    ...
    success: function (response) {
        ...
        prods.forEach(product => {
            ...
            let html = `
              ...
              <form method="post" enctype="multipart/form-data" class="form_show_products">
                ...
                <div class='input_div'>
                <b>Име:</b> <br><input style="width: 275px" type='text' value='${name}' name='modify_name' class="name_value"><br><br>
               ...
               <div class="textarea_div_descr">
               <textarea name='modify_desc' class='prods_textarea'> ${desc}</textarea>
               </div>
        ...
        document.querySelectorAll('.prods_textarea').forEach(element => {
          ClassicEditor
            .create(element)
            .then(editor => {
              // Store the editor instance if needed
