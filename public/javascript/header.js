let product_numbers = document.querySelectorAll('.cart_products_number');
let numbArray = JSON.parse(sessionStorage.getItem('data'));

if(numbArray === null || numbArray.length === 0) {
  product_numbers.forEach(function(product_numb) {
...
setTimeout(function () { 
  ...
  if(cookieModal) { 
    ...
    cookieModal.style.transform = 'translateY(-40px)';
    cookieModal.style.transition = "2s";
  }
