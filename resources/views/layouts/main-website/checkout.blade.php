...
<body>
  ...
  <div class="full_content">
    ...
    <div class="fast_order">
      <p>Имате нужда от помощ?</p>
      <p><a class="phone_checkout" href="tel:0894938614">Направете бърза поръчка на телефон <br> 0894 938 614</a></p>
...
<div class="first_half shadow">
  ...
  <br>
    ...
    <label class="delivery_lable">Доставка до офис <br> на Speedy</label><br>
    ...
    <label class="delivery_lable">Доставка до офис <br> на Еконт</label><br>
    ...
    <label class="delivery_lable_personalAddress" >Доставка до  личен адрес</label>
